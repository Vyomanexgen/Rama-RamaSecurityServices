...
//   return (
//     <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-blue-800 to-blue-600 px-3 py-10 relative overflow-hidden">
      
//       {/* Background pattern dots */}
//       <div className="absolute inset-0 opacity-20 bg-[url('https://www.transparenttextures.com/patterns/dot-grid.png')]"></div>

//       <div className="absolute top-5 left-5 flex items-center gap-2 cursor-pointer"
//            onClick={() => navigate("/")}>
//         <FaArrowLeft className="text-white text-lg animate-pulse" />
//         <span className="text-white">Back to Home</span>
//       </div>

//       <div className="text-center mt-2 absolute top-10">
//         <img
//           src="https://cdn-icons-png.flaticon.com/512/3135/3135715.png"
//           alt="logo"
//           className="w-12 mx-auto"
//         />
//         <p className="text-white font-semibold mt-2">Rama & Rama</p>
//       </div>

//       {/* Card */}
//       <div className="w-full max-w-md bg-white/10 backdrop-blur-lg shadow-xl rounded-2xl p-8 text-white animate-fadeIn mt-32 border border-white/20">
...
//             <div className="flex items-center bg-white rounded-lg shadow-sm px-3">
...
//             </label>
//             <Link className="text-blue-200 hover:underline">
//               Forgot password?
//             </Link>
//           </div>

//           {/* Login Button */}
//           <button className="w-full py-3 bg-blue-700 hover:bg-blue-800 transition rounded-lg font-semibold">
//             Log In
//           </button>
...
//             <Link to="/signup" className="text-blue-200 ml-1">
//               Sign Up
//             </Link>
//           </p>
//         </form>
...
//         {/* Demo Credentials */}
//         <div className="bg-white/20 rounded-lg p-4 mt-6 text-sm">
//           <p className="font-semibold">Demo Credentials:</p>
//           <p className="text-gray-200 break-words">
//             employee@ramarama.com / employee@123
//           </p>
//         </div>

//         <p className="text-center text-xs mt-5 text-gray-200">
