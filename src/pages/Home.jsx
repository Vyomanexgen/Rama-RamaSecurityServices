...
//                 {slide.text}
//               </p>
//               <button className="bg-white text-[#0b2b7a] font-medium px-6 py-3 rounded-lg shadow hover:bg-gray-100 transition">
//                 Contact Now
//               </button>
//             </div>
//           </div>
...
//         {/* Carousel Dots */}
//         <div className="absolute bottom-8 inset-x-0 flex justify-center space-x-3 z-30">
//           {slides.map((_, index) => (
//             <button
//               key={index}
