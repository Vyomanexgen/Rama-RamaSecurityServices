...
//         />
//         <button className="flex items-center gap-2 bg-black text-white px-5 py-3 rounded-xl hover:opacity-80 transition">
//          <FaUserPlus size={18} /> Add Employee    {/* at this  add popup*/}
//         </button>
//       </div>
