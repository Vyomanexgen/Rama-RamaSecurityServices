...
//             <div key={i} className="bg-[#163d9a] rounded-xl p-6 text-left flex flex-col justify-between hover:bg-[#1b47b8] transition">
//               <div className="flex mb-4">
//                 {[...Array(5)].map((_, j) => <StarIcon key={j} className="w-5 h-5 text-yellow-400" />)}
//               </div>
//               <p className="text-gray-100 italic mb-6 leading-relaxed">"{t.text}"</p>
//               <div className="flex items-center gap-3">
//                 <div className="bg-blue-600 w-10 h-10 rounded-full flex items-center justify-center text-white font-semibold">{t.initials}</div>
//                 <div>
